            ...
            <div className="flex py-10 gap-20 sm:flex-col">
                ...
                <div className='flex items-center justify-center gap-10 sm:flex-col'>
                    <div className='flex flex-col gap-5'>
                        <h1 className="text-secondary text-2xl">{CoursesData[selectedItemIndex].title}</h1>
                        <p className="text-white">{CoursesData[selectedItemIndex].description}</p>
                    ...
                    <img
                      src={CoursesData[selectedItemIndex].image} 
                      alt="" 
                      className='h-52 w-80' />
                </div>
                <div>

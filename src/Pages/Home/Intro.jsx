...
function Intro() {
	return (
		<div className='h-[80vh] bg-primary flex flex-col items-start justify-center gap-8 py-10 '>
			...
			<p className='text-white  w-2/4 sm:w-full'>
				Im A Mern Stack Web Developer. Currently ,I'm working as a full Stack
				Developer in Ghana. I also Contribute to Open Souce Project On GitHub
			</p>
